...
namespace infra
{
    ...
    template<class T, class P1>
    class VerifyingFunctionMock<T(P1)>
    {
    public:
    ...
    template<class T, class P1, class P2>
    class VerifyingFunctionMock<T(P1, P2)>
    {
    public:
        ...
        operator infra::Function<T(P1, P2)>()
        {
