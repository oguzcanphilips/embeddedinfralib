...
namespace infra
{
    ...
    class BoundedPriorityQueue<T, -1, Compare>
    {
    public:
        typedef T value_type;
        typedef T& reference;
    ...
    template<class T, class Compare>
    BoundedPriorityQueue<T, -1, Compare>::BoundedPriorityQueue(const Compare& comp)
        : compare(comp)
    {}

    template<class T, class Compare>
    template <class InputIterator>
    BoundedPriorityQueue<T, -1, Compare>::BoundedPriorityQueue(InputIterator first, InputIterator last, const Compare& comp)
        : values(first, last)
        , compare(comp)
    {
        std::make_heap(values.begin(), values.end(), compare);
    ...
    template<class T, class Compare>
    BoundedPriorityQueue<T, -1, Compare>::BoundedPriorityQueue(BoundedPriorityQueue&& other)
        : values(std::move(other.values))
        , compare(std::move(other.compare))
    {}

    template<class T, class Compare>
    BoundedPriorityQueue<T, -1, Compare>& BoundedPriorityQueue<T, -1, Compare>::operator=(BoundedPriorityQueue&& other)
    {
        values = std::move(other.values);
        compare = std::move(other.compare);
    ...
    template<class T, class Compare>
    typename BoundedPriorityQueue<T, -1, Compare>::iterator BoundedPriorityQueue<T, -1, Compare>::begin()
    {
        return values.begin();
    }

    template<class T, class Compare>
    typename BoundedPriorityQueue<T, -1, Compare>::const_iterator BoundedPriorityQueue<T, -1, Compare>::begin() const
    {
        return values.begin();
    }

    template<class T, class Compare>
    typename BoundedPriorityQueue<T, -1, Compare>::iterator BoundedPriorityQueue<T, -1, Compare>::end()
    {
        return values.end();
    }

    template<class T, class Compare>
    typename BoundedPriorityQueue<T, -1, Compare>::const_iterator BoundedPriorityQueue<T, -1, Compare>::end() const
    {
        return values.end();
    }

    template<class T, class Compare>
    typename BoundedPriorityQueue<T, -1, Compare>::reverse_iterator BoundedPriorityQueue<T, -1, Compare>::rbegin()
    {
        return values.rbegin();
    }

    template<class T, class Compare>
    typename BoundedPriorityQueue<T, -1, Compare>::const_reverse_iterator BoundedPriorityQueue<T, -1, Compare>::rbegin() const
    {
        return values.rbegin();
    }

    template<class T, class Compare>
    typename BoundedPriorityQueue<T, -1, Compare>::reverse_iterator BoundedPriorityQueue<T, -1, Compare>::rend()
    {
        return values.rend();
    }

    template<class T, class Compare>
    typename BoundedPriorityQueue<T, -1, Compare>::const_reverse_iterator BoundedPriorityQueue<T, -1, Compare>::rend() const
    {
        return values.rend();
    }

    template<class T, class Compare>
    typename BoundedPriorityQueue<T, -1, Compare>::const_iterator BoundedPriorityQueue<T, -1, Compare>::cbegin() const
    {
        return values.cbegin();
    }

    template<class T, class Compare>
    typename BoundedPriorityQueue<T, -1, Compare>::const_iterator BoundedPriorityQueue<T, -1, Compare>::cend() const
    {
        return values.cend();
    }

    template<class T, class Compare>
    typename BoundedPriorityQueue<T, -1, Compare>::const_reverse_iterator BoundedPriorityQueue<T, -1, Compare>::crbegin() const
    {
        return values.crbegin();
    }

    template<class T, class Compare>
    typename BoundedPriorityQueue<T, -1, Compare>::const_reverse_iterator BoundedPriorityQueue<T, -1, Compare>::crend() const
    {
        return values.crend();
    }

    template<class T, class Compare>
    bool BoundedPriorityQueue<T, -1, Compare>::empty() const
    {
        return values.empty();
    }

    template<class T, class Compare>
    bool BoundedPriorityQueue<T, -1, Compare>::full() const
    {
        return values.full();
    }

    template<class T, class Compare>
    typename BoundedPriorityQueue<T, -1, Compare>::size_type BoundedPriorityQueue<T, -1, Compare>::size() const
    {
        return values.size();
    }

    template<class T, class Compare>
    typename BoundedPriorityQueue<T, -1, Compare>::reference BoundedPriorityQueue<T, -1, Compare>::top()
    {
        return values.front();
    }

    template<class T, class Compare>
    typename BoundedPriorityQueue<T, -1, Compare>::const_reference BoundedPriorityQueue<T, -1, Compare>::top() const
    {
        return values.front();
    }

    template<class T, class Compare>
    const typename BoundedPriorityQueue<T, -1, Compare>::value_type& BoundedPriorityQueue<T, -1, Compare>::operator[](size_type position) const
    {
        return values[position];
    }

    template<class T, class Compare>
    void BoundedPriorityQueue<T, -1, Compare>::push(const_reference value)
    {
        values.push_back(value);
        std::push_heap(values.begin(), values.end(), compare);
    }
    ...
    template<class T, class Compare>
    void BoundedPriorityQueue<T, -1, Compare>::push(value_type&& value)
    {
        values.push_back(std::move(value));
        std::push_heap(values.begin(), values.end(), compare);
    }
    ...
    template<class T, class Compare>
    void BoundedPriorityQueue<T, -1, Compare>::pop()
    {
        std::pop_heap(values.begin(), values.end(), compare);
        values.pop_back();
    }
    ...
    template<class T, class Compare>
    void BoundedPriorityQueue<T, -1, Compare>::clear()
    {
        values.clear();
    }

    template<class T, class Compare>
    void BoundedPriorityQueue<T, -1, Compare>::erase(iterator position)
    {
        erase_heap(values.begin(), values.end(), position, compare);
        values.pop_back();
    }
    ...
    template<class T, class Compare>
    template<class... Args>
    void BoundedPriorityQueue<T, -1, Compare>::emplace(Args&&... args)
    {
        values.emplace_back(std::forward<Args>(args)...);
        std::push_heap(values.begin(), values.end(), compare);
    }
    ...
    template<class T, class Compare>
    void BoundedPriorityQueue<T, -1, Compare>::swap(BoundedPriorityQueue& other)
    {
        using std::swap;
        swap(values, other.values);
        swap(compare, other.compare);
