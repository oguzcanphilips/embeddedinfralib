#include "infra/util/public/Tokenizer.hpp"
...
namespace infra
{
    ...
    {
        std::size_t result = 0;
        std::size_t start = SkipConsequetiveSeparators(0);
    ...
    {
        return SkipConsequetiveSeparators(string.find(separator, start));
    }

    std::size_t Tokenizer::SkipConsequetiveSeparators(std::size_t index) const
    {
