...
#include "upgrade_boot_loader/DecryptorAesTiny.hpp"
#include "upgrade_boot_loader/DecryptorAesMbedTls.hpp"
...
TEST_F(DecryptorAesTest, DecryptPartLarge)
{
    ...
    EXPECT_EQ((std::vector<uint8_t>{
        ...
        0x40, 0x71, 0xb6, 0xef, 0x68, 0xfa, 0x22, 0x1a }), dataTiny);
    EXPECT_EQ((std::vector<uint8_t>{
        0xc7, 0xa3, 0x38, 0x33, 0x82, 0x89, 0x5c, 0x8a,
        0x66, 0x45, 0x8a, 0x6e, 0xac, 0xc6, 0xd7, 0x69,
        0x72, 0x44, 0x10, 0x91, 0x90, 0xc6, 0xb3, 0x16,
        0x40, 0x71, 0xb6, 0xef, 0x68, 0xfa, 0x22, 0x1a }), dataMbedTls);
}
