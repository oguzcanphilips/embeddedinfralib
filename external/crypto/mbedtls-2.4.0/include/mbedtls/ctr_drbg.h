...
typedef struct
{
    ...
    mbedtls2_aes_context aes_ctx;        /*!<  AES context       */
 ...
 *                      Makes the context ready for mbedtls2_ctr_drbg_seed() or
 ...
 */
void mbedtls2_ctr_drbg_set_prediction_resistance( mbedtls2_ctr_drbg_context *ctx,
                                         int resistance );
 ...
 */
void mbedtls2_ctr_drbg_set_entropy_len( mbedtls2_ctr_drbg_context *ctx,
                               size_t len );
 ...
 */
void mbedtls2_ctr_drbg_set_reseed_interval( mbedtls2_ctr_drbg_context *ctx,
                                   int interval );
 ...
 *                      MBEDTLS_ERR_CTR_DRBG_REQUEST_TOO_BIG
 */
int mbedtls2_ctr_drbg_random( void *p_rng,
                     unsigned char *output, size_t output_len );
...
int mbedtls2_ctr_drbg_seed_entropy_len( mbedtls2_ctr_drbg_context *,
