 ...
 */
typedef int (*mbedtls2_entropy_f_source_ptr)(void *data, unsigned char *output, size_t len,
                            size_t *olen);
...
typedef struct
{
    mbedtls2_entropy_f_source_ptr    f_source;   /**< The entropy source callback */
...
#endif
    int             source_count;
    mbedtls2_entropy_source_state    source[MBEDTLS_ENTROPY_MAX_SOURCES];
#if defined(MBEDTLS_HAVEGE_C)
