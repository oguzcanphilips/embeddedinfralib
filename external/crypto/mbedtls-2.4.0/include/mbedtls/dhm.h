...
typedef struct
{
    ...
    mbedtls2_mpi P;      /*!<  prime modulus     */
    mbedtls2_mpi G;      /*!<  generator         */
    mbedtls2_mpi X;      /*!<  secret value      */
    mbedtls2_mpi GX;     /*!<  self = G^X mod P  */
    mbedtls2_mpi GY;     /*!<  peer = G^Y mod P  */
    mbedtls2_mpi K;      /*!<  key = GY^X mod P  */
    mbedtls2_mpi RP;     /*!<  cached R^2 mod P  */
    mbedtls2_mpi Vi;     /*!<  blinding value    */
    mbedtls2_mpi Vf;     /*!<  un-blinding value */
    mbedtls2_mpi pX;     /*!<  previous X        */
}
 ...
 *                 using mbedtls2_mpi_read_string or mbedtls2_mpi_read_binary).
 *
 * \return         0 if successful, or an MBEDTLS_ERR_DHM_XXX error code
 */
