...
{
    return( 8 * ((const mbedtls2_rsa_context *) ctx)->len );
}
                   ...
                   const unsigned char *sig, size_t sig_len )
{
    ...
    if( sig_len < ((mbedtls2_rsa_context *) ctx)->len )
        return( MBEDTLS_ERR_RSA_VERIFY_FAILED );

    if( ( ret = mbedtls2_rsa_pkcs1_verify( (mbedtls2_rsa_context *) ctx, NULL, NULL,
...
{
    *sig_len = ((mbedtls2_rsa_context *) ctx)->len;

    return( mbedtls2_rsa_pkcs1_sign( (mbedtls2_rsa_context *) ctx, f_rng, p_rng, MBEDTLS_RSA_PRIVATE,
...
static int rsa_decrypt_wrap( void *ctx,
                    ...
                    int (*f_rng)(void *, unsigned char *, size_t), void *p_rng )
{
    if( ilen != ((mbedtls2_rsa_context *) ctx)->len )
        return( MBEDTLS_ERR_RSA_BAD_INPUT_DATA );

    return( mbedtls2_rsa_pkcs1_decrypt( (mbedtls2_rsa_context *) ctx, f_rng, p_rng,
...
static int rsa_encrypt_wrap( void *ctx,
                    ...
                    int (*f_rng)(void *, unsigned char *, size_t), void *p_rng )
{
    *olen = ((mbedtls2_rsa_context *) ctx)->len;

    if( *olen > osize )
        return( MBEDTLS_ERR_RSA_OUTPUT_TOO_LARGE );

    return( mbedtls2_rsa_pkcs1_encrypt( (mbedtls2_rsa_context *) ctx,
                f_rng, p_rng, MBEDTLS_RSA_PUBLIC, ilen, input, output ) );
}

static int rsa_check_pair_wrap( const void *pub, const void *prv )
{
    return( mbedtls2_rsa_check_pub_priv( (const mbedtls2_rsa_context *) pub,
...
{
    return( mbedtls2_ecp_check_pub_priv( (const mbedtls2_ecp_keypair *) pub,
                       ...
                       const unsigned char *sig, size_t sig_len )
{
    ...
    ret = mbedtls2_ecdsa_read_signature( (mbedtls2_ecdsa_context *) ctx,
...
static int ecdsa_sign_wrap( void *ctx, mbedtls2_md_type_t md_alg,
                   ...
                   int (*f_rng)(void *, unsigned char *, size_t), void *p_rng )
{
    return( mbedtls2_ecdsa_write_signature( (mbedtls2_ecdsa_context *) ctx,
...
{
    const mbedtls2_rsa_alt_context *rsa_alt = (const mbedtls2_rsa_alt_context *) ctx;
...
static int rsa_alt_sign_wrap( void *ctx, mbedtls2_md_type_t md_alg,
                   ...
                   int (*f_rng)(void *, unsigned char *, size_t), void *p_rng )
{
    mbedtls2_rsa_alt_context *rsa_alt = (mbedtls2_rsa_alt_context *) ctx;
...
{
    void *ctx = mbedtls2_calloc( 1, sizeof( mbedtls2_rsa_alt_context ) );
...
{
    mbedtls2_zeroize( ctx, sizeof( mbedtls2_rsa_alt_context ) );
    mbedtls2_free( ctx );
}
