...
#include "hal/interfaces/test_doubles/public/I2cMock.hpp"
...
TEST_F(I2cMultipleAccessTest, FirstReceiveIsExecuted)
{
    ...
    access1.ReceiveData(hal::I2cAddress(1), buffer, hal::Action::stop, 100, [](hal::Result) {});
    ExecuteAllActions();
}
...
TEST_F(I2cMultipleAccessTest, SecondReceiveIsNotExecuted)
{
    ...
    EXPECT_CALL(i2c, ReceiveDataMock(testing::_, hal::Action::stop)).WillOnce(testing::Return(std::vector<uint8_t>{ 5 }));
    access1.ReceiveData(hal::I2cAddress(1), buffer, hal::Action::stop, 100, [](hal::Result) {});
    access2.ReceiveData(hal::I2cAddress(1), buffer, hal::Action::stop, 100, [](hal::Result) {});
    ExecuteAllActions();
}
...
TEST_F(I2cMultipleAccessTest, AfterReceiveWithRepeatedStartClaimIsNotReleased)
{
    ...
    access1.ReceiveData(hal::I2cAddress(1), buffer, hal::Action::repeatedStart, 100, [](hal::Result) {});
    access2.ReceiveData(hal::I2cAddress(1), buffer, hal::Action::stop, 100, [](hal::Result) {});
    ExecuteAllActions();
...
TEST_F(I2cMultipleAccessTest, AfterReceiveWithContinueSessionClaimIsNotReleased)
{
    ...
    access1.ReceiveData(hal::I2cAddress(1), buffer, hal::Action::continueSession, 100, [](hal::Result) {});
    access2.ReceiveData(hal::I2cAddress(1), buffer, hal::Action::stop, 100, [](hal::Result) {});
    ExecuteAllActions();
...
TEST_F(I2cMultipleAccessTest, FirstSendIsExecuted)
{
    ...
    access1.SendData(hal::I2cAddress(1), buffer, hal::Action::stop, 100, [](hal::Result, uint32_t) {});
    ExecuteAllActions();
}
...
TEST_F(I2cMultipleAccessTest, SecondSendIsNotExecuted)
{
    ...
    EXPECT_CALL(i2c, SendDataMock(testing::_, hal::Action::stop, std::vector<uint8_t>{ 5 }));
    access1.SendData(hal::I2cAddress(1), buffer, hal::Action::stop, 100, [](hal::Result, uint32_t) {});
    access2.SendData(hal::I2cAddress(1), buffer, hal::Action::stop, 100, [](hal::Result, uint32_t) {});
    ExecuteAllActions();
}
...
TEST_F(I2cMultipleAccessTest, AfterSendWithRepeatedStartClaimIsNotReleased)
{
    ...
    access1.SendData(hal::I2cAddress(1), buffer, hal::Action::repeatedStart, 100, [](hal::Result, uint32_t) {});
    access2.SendData(hal::I2cAddress(1), buffer, hal::Action::stop, 100, [](hal::Result, uint32_t) {});
    ExecuteAllActions();
...
TEST_F(I2cMultipleAccessTest, AfterSendWithContinueSessionClaimIsNotReleased)
{
    ...
    access1.SendData(hal::I2cAddress(1), buffer, hal::Action::continueSession, 100, [](hal::Result, uint32_t) {});
    access2.SendData(hal::I2cAddress(1), buffer, hal::Action::stop, 100, [](hal::Result, uint32_t) {});
    ExecuteAllActions();
